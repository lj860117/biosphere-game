...
| 场景 | 应加载的 Skill | 说明 |
|------|--------------|------|
| 需要修改 SceneCraft 的光照管理代码（SceneLightManager） | `scenecraft-dev` | SceneCraft 开发规范 |
| 场景检查中涉及材质/Shader 问题 | `scenecraft-agent` | SceneCraft 操作指南 |
| APV/Shader 开发，查踩坑记录 | `unity-knowledge-guardian` | APV-1~8 踩坑记录 + 主动提醒 |
| 地形相关渲染（Terrain Shader、地形材质） | 先读 `hermanlei-conventions/references/terrain-pcg-knowledge-index.md` | 地形和 PCG 知识 |
